            ...
            <div className="bg-white shadow-lg rounded-lg w-full max-w-xl p-5 duration-500 dark:bg-zinc-700">
                ...
                <div>
                    <div className="flex gap-2 mt-6">
                        ...
                        <Input type='text' placeholder='Enter last name' className= 'border-2 focus:border-black duration-500 dark:bg-zinc-700 dark:border-zinc-600 dark:focus:bg-zinc-700 dark:text-white dark:focus:border-zinc-800'/>
                    </div>
