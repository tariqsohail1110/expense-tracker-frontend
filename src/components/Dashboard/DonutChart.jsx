...
function DonutChart() {
    ...
    return (
        <>
            <div className='bg-white rounded-lg shadow-md p-6 border flex flex-col items-center justify-center mb-6'>
                <h1 className='font-sans text-black font-bold text-lg'>Category Based Spendings</h1>
